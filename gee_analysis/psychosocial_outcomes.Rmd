---
title: "GEE analysis (Psychosocial)"
...
# Merge all domains
full_data <- bind_rows(quality_long, activity_long, depression_long, selfeff_long) %>%
...
```{r}
# Domains to analyze
domains <- c("quality", "activity", "depression", "selfeff")
